...
export const initialSites: Site[] = [
  ...
  { id: '36', name: 'foreignbride.cenix',activeBranch: 'main', branches: ['loading'], server: 'ftp', url: 'http://foreignbride.cenix',folderPath: 'R:/c_affil/foreignbride.com',assigned: 'afacebu.wilfredo@gmail.com',},
  ...
  { id: '60', name: 'shenzhenwomen.cenix',activeBranch: 'main', branches: ['loading'], server: 'ftp', url: 'http://shenzhenwomen.cenix',folderPath: 'R:/WebServer2/shenzhenwomen',assigned: 'afacebu.benjiebroa@gmail.com',},
