// pages/website-banch-manager.tsx
...
export default function Home() {
  ...
  useEffect(() => {
    // Debounce branch loading so rapid search/pagination changes don't trigger
    // a flood of requests. Wait 1 second after paginatedSites changes.
